...
router.get('/student-dashboard/:studentId', studentIdAuth, ctr.studentDashboardPage);
router.get('/student-dashboard/:id/:detail', ctr.commentsPage);
router.get('/student-dashboard/:id/:detail/edit', ctr.studentDetailPage);
